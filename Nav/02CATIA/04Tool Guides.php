	...
	<div id="background">
		<article>
			...
			<div class='alphabet_index' id='C'>
				...
				<a href='Tools/Circular'>Circular Pattern</a><br>
				<a href='Tools/Close'>Close Surface</a><br>
			</div>
			<div class='alphabet_index' id='D'>
				<h1>D</h1>
				<a href='Tools/Dynamic'>Dynamic Sectioning</a><br>
			</div>
			<div class='alphabet_index' id='F'>
				<h1>F</h1>
				<a href='Tools/Fillet'>Fillet Radius</a><br>
			</div>
			<div class='alphabet_index' id='G'>
				<h1>G</h1>
				<a href='Tools/Groove'>Groove</a><br>
			</div>
			<div class='alphabet_index' id='H'>
				<h1>H</h1>
				<a href='Tools/Hole'>Hole</a><br>
			</div>
			<div class='alphabet_index' id='I'>
				<h1>I</h1>
				<a href='Tools/Intersect'>Intersect</a><br>
			</div>
			<div class='alphabet_index' id='L'>
				<h1>L</h1>
				<a href='Tools/Line'>Line</a><br>
			</div>
			<div class='alphabet_index' id='M'>
				<h1>M</h1>
				<a href='Tools/Mirror'>Mirror</a><br>
				<a href='Tools/MultiSection'>Multi-Section Solid</a><br>
			</div>
			<div class='alphabet_index' id='P'>
				<h1>P</h1>
				<a href='Tools/Pad'>Pad</a><br>
				<a href='Tools/Plane'>Plane</a><br>
				<a href='Tools/Pocket'>Pocket</a><br>
				<a href='Tools/Points'>Points</a><br>
			</div>
			<div class='alphabet_index' id='R'>
				<h1>R</h1>
				<a href='Tools/Remove'>Remove</a><br>
				<a href='Tools/Rectangular'>Rectangular Pattern</a><br>
			</div>
			<div class='alphabet_index' id='S'>
				<h1>S</h1>
				<a href='Tools/Scaling'>Scaling</a><br>
				<a href='Tools/Shaft'>Shaft</a><br>
				<a href='Tools/Shell'>Shell</a><br>
				<a href='Tools/Sketch'>Sketch Solving Status</a><br>
				<a href='Tools/Split'>Split</a><br>
			</div>
			<div class='alphabet_index' id='T'>
				<h1>T</h1>
				<a href='Tools/Thickness'>Thickness</a><br>
				<a href='Tools/Tick_Profile'>Thick Profile</a><br>
				<a href='Tools/Thick_Surface'>Thick Surface</a><br>
				<a href='Tools/Translation'>Translation</a><br>
				<a href='Tools/Trim'>Trim</a><br>
			</div>
			<div class='alphabet_index' id='U'>
				<h1>U</h1>
				<a href='Tools/User'>User Pattern</a><br>
			</div>
			<div class='alphabet_index' id='W'>
				<h1>W</h1>
				<a href='Tools/Wall'>Wall Thickness Analysis</a><br>
			</div>
  		</article>
	</div>
</body>
