...
<body>
	<div id="main">
		...
		<div class="episode">
			<h3 id="cord">Angle Bracket 3D - 2:</h3>
			<div class="content">
				<div class="video">
		...
		<div class="episode">
			<h3 id="cord">Angle Bracket 3D - 3:</h3>
			<div class="content">
				<div class="video">
		...
		<div class="episode">
			<h3 id="cord">Angle Bracket 3D - 4:</h3>
			<div class="content">
				<div class="video">
		...
		<div class="episode">
			<h3 id="cord">Angle Bracket 3D - 5:</h3>
			<div class="content">
				<div class="video">
		...
		<div class="episode">
			<h3 id="cord">Angle Bracket 3D - 6:</h3>
			<div class="content">
				<div class="video">
		...
		<div class="episode">
			<h3 id="cord">Angle Bracket 3D - 7:</h3>
			<div class="content">
				<div class="video">
		...
		<div class="episode">
			<h3 id="cord">Angle Bracket 3D - 8:</h3>
			<div class="content">
				<div class="video">
