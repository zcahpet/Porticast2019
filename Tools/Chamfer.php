<body>
	<div id="background">
		<article>
			...
			<p>
			<b>
				The Chamfer tool adds a bevelled or angled corner to the edge of a part. They can be used to remove sharp external edges created in castings or machined parts
			</b>
				<br>
				Click on the Chamfer tool.
				<br>
				<img class="tools_image" src="Tools/Tools_Images/Chamfer/chamfer_icon.gif">
				<br>
				...
				<br>
				<img class="tools_image" src="Tools/Tools_Images/Chamfer/chamfer_menu.png">
				<br>
				...
				<br>
				<img class="tools_image" src="Tools/Tools_Images/Chamfer/chamfer_preview.png">
				<br>
				Click OK, and the part should look like this.
				<br>
				<img class="tools_image" src="Tools/Tools_Images/Chamfer/chamfer_result.png">
			</p>
	</article>
	</div>
</body>
