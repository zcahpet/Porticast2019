<body>
	<div id="background">
		<article>
			<h1>Translation</h1>
			<p>
				<b>Translation is a function that moves every point of the PartBody in the same direction and distance.</b>
				<br>
				The translation tool is normally used when the user wants to change the location of the datum of a Body or to move power copies in the part file.
				<br></br>
