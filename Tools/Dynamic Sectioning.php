<body>
	<div id="background">
		<article>
			<h1>Dynamic Sectioning Tool</h1>
			<p>
			<b>
				The Dynamic Sectioning tool is used to create a section through a part / assembly.
			</b>
				 This can be useful when you have a complex project and want to see hidden details.
				<br>
				<br>
