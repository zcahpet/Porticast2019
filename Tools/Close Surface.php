<body>
	<div id="background">
		<article>
			<h1>Close Surface Tool</h1>
			<p>
			<b>
				The Close Surface tool is a feature that fills up the empty spaces between surfaces.
			</b>
				It is particularly useful in situations where a manufacturer sends CAD files in surface forms, often as an IGES file.
				<br>
				<br>
