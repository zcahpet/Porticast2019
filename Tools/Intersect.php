<body>
	<div id="background">
		<article>
			<h1>Intersect Tool</h1>
			<p>
			<b>
				The Intersect tool is used to keep the regions where multiple bodies intersect and remove the rest.
			</b>
				<br>
				Click on the Intersect tool.
				<br>
				<img src="Tools/Tools_Images/Intersect/Intersect_icon.png">
				<br>
				...
				<br>
				<img src="Tools/Tools_Images/Intersect/Intersect_parts.png">
				<br>
				...
				<br>
				<img src="Tools/Tools_Images/Intersect/Intersect_product.png">
			</p>
	</article>
	</div>
</body>
