<body>
	<div id="background">
		<article>
			<h1>Trim Tool</h1>
			<p>
				<b>The trim tool is used to “cut off” excess lines within a sketch and can be found within the sketch tools toolbar.</b>
				<br>
				...
				Trim first element:
				<br>
				<img style="padding: 10px 0px;" src="Tools/Tools_Images/Trim/Trim-first-element.png">
				<br>
			</p>
	</article>
	</div>
